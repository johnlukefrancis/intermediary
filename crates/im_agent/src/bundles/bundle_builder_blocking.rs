...
mod tests {
    ...
    #[test]
    fn respects_empty_global_excludes_when_user_sends_empty() {
        ...
        assert!(excludes.dir_names.is_empty());
        assert!(excludes.dir_suffixes.is_empty());
        assert!(excludes.file_names.is_empty());
        assert!(excludes.extensions.is_empty());
        assert!(excludes.patterns.is_empty());
    }

    #[test]
    fn respects_user_global_excludes_without_recommended_merge() {
