// Path: crates/im_agent/src/source_control/image_diff.rs
...
use super::image_diff_sides::{blob_side, head_blob_exists, worktree_side};
...
use super::SourceControlImageDiff;
...
pub(super) async fn capture_image_diff(
    repo_root: &Path,
    path: &str,
