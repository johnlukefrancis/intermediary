...
// Description: Login-shell command-line builders and quoting for launching and signalling the WSL agent

use crate::wsl_control::normalize_distro;
...
mod tests {
    use super::{
        build_wsl_bash_args, build_wsl_signal_pids_command_line, build_wsl_spawn_command_line,
    };
