...
Status: Superseded by Auto Files. The app no longer exposes favourites in the file UI, though legacy `starredFiles` config remains loadable for compatibility.
